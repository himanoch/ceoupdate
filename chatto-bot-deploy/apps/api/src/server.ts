...
import { KnowledgeBaseService, ToolRegistry, KnowledgeIngestionService, AgentPromptService, LLMGateway } from '../../../packages/agent-runtime/src/index.js';
...
const llmGateway = new LLMGateway(tools);
...
const orchestrator = new AgentOrchestrator(crm, kb, tools, audit, analytics, promptService, llmGateway);
